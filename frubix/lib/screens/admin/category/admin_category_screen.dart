  ...
  Widget build(BuildContext context) {
    return Scaffold(
                            ...
                            DataCell(
                              CircleAvatar(
                                backgroundImage: MemoryImage(
                                  base64Decode(data[CATEGORY_PIC]),
                                ),
                              ),
                            ),
                              ...
                              Row(
                                children: [
                                  IconButton(
                                    onPressed: () {
                                      context.go(
                                        Routes.adminEditCategoryScreen
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          context.pushReplacement(Routes.adminAddCategoryScreen);
        },
        ...
        return CupertinoAlertDialog(
          ...
          actions: [
            ...
            CupertinoDialogAction(
              ...
              onPressed: () {
                Category.deleteCategory(context: context, id: id);
                Navigator.of(context).pop();
              },
            ),
          ],
