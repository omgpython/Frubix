      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // GestureDetector(
            //   onTap: () {
            //     context.push(Routes.userSearchProductScreen);
            //   },
            //   child: Padding(
            ...
            //       ),
            //       hintTexts: [
            //         "Milk & bread in 10 minutes!",
            //         "Need snacks for movie night?",
            //         "Fresh fruits delivered fast",
            //         "Running low on essentials?",
            //         "Get ice cream before it melts 🍦",
            //         "Order now, cook in 15!",
            //         "Craving chips or chocolate?",
            //         "Quick dinner fix ideas",
            //         "Juices, colas & mixers 🍹",
            //         "All your daily needs, delivered",
            //         "Diapers at your doorstep 👶",
            //         "Late-night cravings? We got you!",
            //         "Rainy day? Order in ☔",
            //         "Breakfast in a click 🥐",
            //         "Shop now, save time ⏱️",
            //       ],
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () {
                  context.push(
                    Routes.userSearchProductScreen,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: AnimatedTextKit(
                          animatedTexts: [
                            TyperAnimatedText("Milk & bread in 10 minutes!"),
                            TyperAnimatedText("Need snacks for movie night?"),
                            TyperAnimatedText("Fresh fruits delivered fast"),
                            TyperAnimatedText("Running low on essentials?"),
                            TyperAnimatedText(
                              "Get ice cream before it melts 🍦",
                            ),
                            TyperAnimatedText("Order now, cook in 15!"),
                            TyperAnimatedText("Craving chips or chocolate?"),
                            TyperAnimatedText("Quick dinner fix ideas"),
                            TyperAnimatedText("Juices, colas & mixers 🍹"),
                            TyperAnimatedText(
                              "All your daily needs, delivered",
                            ),
                            TyperAnimatedText("Diapers at your doorstep 👶"),
                            TyperAnimatedText(
                              "Late-night cravings? We got you!",
                            ),
                            TyperAnimatedText("Rainy day? Order in ☔"),
                            TyperAnimatedText("Breakfast in a click 🥐"),
                            TyperAnimatedText("Shop now, save time ⏱️"),
                          ],
