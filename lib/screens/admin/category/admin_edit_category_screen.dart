...
class AdminEditCategoryScreen extends StatefulWidget {
  String id;
  AdminEditCategoryScreen({super.key, required this.id});
...
class _AdminEditCategoryScreenState extends State<AdminEditCategoryScreen> {
                            ...
                            child:
                                loading
                                    ...
                                    : FilledButton(
                                          ...
                                          if (pic != 'NONE') {
                                            if (manager.getAdminRole() ==
                                              ...
                                              Alert(
                                                context: context,
                                                message:
                                                    'You are not allow to edit category',
                                                type: 'Warning',
                                              );
                                            }
                                          }
                                      ...
                                      child: Text('Save Category Details'),
                                    ),
                          ),
                        ],
                      ),
  ...
  Future<void> setData() async {
    ...
    _nameController.text = category[CATEGORY_NAME];
    setState(() {
      isLoading = false;
    });
  }
